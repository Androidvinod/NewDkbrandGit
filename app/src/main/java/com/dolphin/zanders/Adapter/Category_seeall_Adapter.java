...
public class Category_seeall_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    private List<ChildData> datumList;
    public Category_seeall_Adapter(FragmentActivity context) {
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        View v1 = inflater.inflate(R.layout.subcategory_row, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        {
            myViewHolder.iv_cat_arrow.setVisibility(View.VISIBLE);
        }else {
            myViewHolder.iv_cat_arrow.setVisibility(View.GONE);
        }
...
/*
        if(datum.getChildrenData().equalsIgnoreCase("1"))
        {
            myViewHolder.lv_arrow.setVisibility(View.VISIBLE);
        }else {
            myViewHolder.lv_arrow.setVisibility(View.GONE);
        }

        if(datum.getSubcategories().equalsIgnoreCase("1"))
        {
            myViewHolder.lv_subcategory_click.setOnClickListener(new View.OnClickListener() {
                @Override
                ...
                public void onClick(final View v) {
                    ...
                    handler.postDelayed(new Runnable() {
                        public void run() {
                            Bundle b=new Bundle();
                            AppCompatActivity activity = (AppCompatActivity) v.getContext();
                            b.putString("subcat_id",datum.getValue());
                            b.putString("subcatename",datum.getName());
                            b.putString("screen","subcategory");
   ...
   /* public void add(Category r) {
    ...
    protected class MyViewHolder extends RecyclerView.ViewHolder {
       ...
       LinearLayout lv_subcategory_click,lv_arrow;
       View viewcat;
       ImageView iv_cat_arrow;

        public MyViewHolder(@NonNull View view) {
            super(view);
            iv_cat_arrow = itemView.findViewById(R.id.iv_cat_arrow);
            viewcat = itemView.findViewById(R.id.viewcat);
            tv_category = itemView.findViewById(R.id.tvSubCategoryName);
            lv_subcategory_click = itemView.findViewById(R.id.lv_subcategory_click);
            lv_arrow = itemView.findViewById(R.id.lv_arrow);
