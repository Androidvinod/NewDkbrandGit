...
import retrofit2.Response;
   ...
   public class NewShippingMethodAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

        Context context;

        private List<NewShippingModel> datumList;
        private int lastSelectedPosition = 0;

        ApiInterface api;


        public NewShippingMethodAdapter(FragmentActivity context,List<NewShippingModel> datumList) {
        ...
        private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
            ...
            viewHolder = new NewShippingMethodAdapter.MyViewHolder(v1);
            return viewHolder;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            final NewShippingModel datum = datumList.get(position);
            api = ApiClient.getClient().create(ApiInterface.class);

            final NewShippingMethodAdapter.MyViewHolder myViewHolder = (NewShippingMethodAdapter.MyViewHolder) holder;

            Log.e("debug", "=" + datum.getCarrierTitle() );
           ...
           myViewHolder.radio_btn_shipping.setText(Html.fromHtml(datum.getCarrierTitle()));
            ...
            myViewHolder.radio_btn_shipping.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //shiping_method = datum.getMethodCode();
                    NewCheckoutFragment.shiping_method_order=datumList.get(position).getMethodTitle()+"-"+datumList.get(position).getCarrierTitle();


                    Log.e("shipingmethod95", "=" +datumList.get(position).getMethodTitle() );
                    Log.e("shipingmethod95", "=" + datumList.get(position).getCarrierTitle());
                    Log.e("shipingmethod95", "=" + NewCheckoutFragment.shiping_method_order );
            ...
            myViewHolder.lv_radio_shiping.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View v) {
                    lastSelectedPosition = position;
                    //   NewShippingModel = cart_delivery_model.getCode();

             /*   if (CheckNetwork.isNetworkAvailable(context)) {
                    CALL_CART_CONFIRM_API(NewShippingModel);
                } else {
...
*/
        ...
        public void add(NewShippingModel r) {
            datumList.add(r);
        ...
        public void addAll(List<NewShippingModel> moveResults) {
            Log.e("debug_124adapter", "" + moveResults.size());
            datumList.clear();
            for (NewShippingModel result : moveResults) {
        ...
        public NewShippingModel getItem(int position) {
