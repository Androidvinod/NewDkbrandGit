...
public class Item {
    ...
    public Item(String isWishlisted, String wishlist_item_id, String image, Integer id, String sku, String name, Integer price, String tierprice, String special_price) {
